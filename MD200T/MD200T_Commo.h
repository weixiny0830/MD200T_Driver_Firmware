...
#ifndef MD200T_COMMON_H_
#define MD200T_COMMON_H_
...
class MD200T_Modbus
{
    ...
    public:
        ...
        {
            MD200T_Modbus::IByte Ret;
            Ret.byLow =  nIn      & 0xff;
            Ret.byHigh = nIn >> 8 & 0xff;
            return Ret;
        }

        LByte Long2Byte(long nIn)
        {
            MD200T_Modbus::LByte Ret;
        ...
        ////////////////// ModBus CRC16///////////////
        int CRC16(int crc, char *buf, int len);
        char GetCheckSum(short nPacketSize, char *byArray);
        // MODBUS protocol.
        int IsCRC16ChkOK(char byIn[], int nPacketSize);
        ...
        // Get the low and high byte from interger
        int MDPutData(char byFuncCode, int nData, char byPort);
        int MDPutLongData(char byFuncCode, long lData, char byPort);
        int Response2Write(char byIn[], int nSize, char byPort);
};
